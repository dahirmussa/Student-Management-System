...
public class CreateNewUsers extends AppCompatActivity {
        ...
        firebaseAuth.createUserWithEmailAndPassword(emails,passwords).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    NewUsers newUsers = new NewUsers(Emails,Passwords,Roles, profile, user_id);
                    reference.setValue(newUsers);
                    ...
                    Toast.makeText(CreateNewUsers.this, "User created successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
